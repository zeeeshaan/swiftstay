...
import 'package:swiftstay/Service_Provider/servicersignup.dart';
...
class Servicerlogin extends StatefulWidget {
  const Servicerlogin({super.key});

  @override
  State<Servicerlogin> createState() => _ServicerloginState();
}

class _ServicerloginState extends State<Servicerlogin> {
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const Servicersignup()),
                        );
                      },
